...
public class JTextListLink {
    ...
    public JTextListLink(JTextField textField, JList list, boolean initiallyMatchListToText) {
        this.updateListener = new UpdateListener(textField, list);
    ...
    /**
     * Links the JTextField contents to the JList.
     * The two are automatically linked after instantiation.
     * Only need to invoke this after unlinking them.
     */
    public void link() {
    ...
    /**
     * Unlinks the JTextField contents from the JList.
     */
    public void unlink() {
     ...
     */
    class UpdateListener implements ListSelectionListener, DocumentListener {
    	...
    	UpdateListener(JTextField textField, JList list) {
    ...
    static public void main(String[] args) {
        ...
        new JTextListLink(textField, list, true);
