...
public class JPagedChooser<V> extends JComponent {
     ...
     */
    public JPagedChooser(Collection<V> options, boolean horizontal, boolean showIndices, int itemsPerPage) {
        super();
        ...
        optionsList.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(clickedIndex > -1 && optionsList.isSelectedIndex(clickedIndex)) {
                	...
                	V value = (V)optionsList.getSelectedValue();
    ...
    public V getValue(int index) {
        ...
        return (V)this.optionsList.getModel().getElementAt(index - 1);
    }
	 ...
	 * @param selection
	 */
	void notifyListeners(V selection) {
	    synchronized(this.selectionListeners) {
	 ...
	 */
    private class ChooserCellRenderer extends JLabel implements ListCellRenderer {
        private boolean showIndices;
    ...
    static public interface SelectionListener<V> extends EventListener {
    	 ...
    	 * @param selection
    	 */
    	public void handleSelection(V selection);   
    }
    ...
    static public void main(String[] args) {
        ...
        List<String> options = new ArrayList<String>(test.length);
        for(String option : test) {
        	options.add(option);
        }
        
        JPagedChooser<String> chooser = new JPagedChooser<String>(options, true, true, 10);
